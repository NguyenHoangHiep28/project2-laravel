                                                    ...
                                                    <form class="restaurant-info-form brd-rd5">
                                                        <div class="row mrg20">
                                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                                ...
                                                                <input name="name-restaurant" class="brd-rd3" type="text">
                                                            </div>
                                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                                <label>Restaurant Phone <sup>*</sup></label>
                                                                <input name="phone-restaurant" class="brd-rd3" type="text">
                                                            </div>
                                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                                <label>Manager Name <sup>*</sup></label>
                                                                <input name="name-manager" class="brd-rd3" type="text">
                                                            </div>
                                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                                <label>Manager Contact phone <sup>*</sup></label>
                                                                <input name="phone-manager" class="brd-rd3" type="text">
                                                            </div>
                                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                                <label>Contact Email <sup>*</sup></label>
                                                                <input name="email-restaurant" class="brd-rd3" type="email">
                                                            </div>
                                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                                ...
                                                                <div class="select-wrp">
                                                                    <select id="country" name="country-restaurant" class="form-control">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                                ...
                                                                <input name="city-restaurant" class="brd-rd3" type="text">
                                                            </div>
                                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                                <label>District <sup>*</sup></label>
                                                                <input name="district-restaurant" class="brd-rd3" type="text">
                                                            </div>
                                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                                <label>Wards <sup>*</sup></label>
                                                                <input name="wards-restaurant" class="brd-rd3" type="text">
                                                            </div>
                                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                                <label>No./Street <sup>*</sup></label>
                                                                <input name="street-restaurant"  class="brd-rd3" type="text">
                                                            </div>
                                                            <div class="col-md-12 col-sm-6 col-lg-12">
                                                                <label>Cuisines <sup>*</sup></label>
                                                                <div class="select-wrp">
                                                                    <select name="cuisines-restaurant">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                                <label>Images Demo Of Restaurant </label>
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                                <div class="step-buttons">
                                                                    <a id="send-register" class="brd-rd3 red-bg" data-toggle="tab"  href="#reservation-tab2" title="" itemprop="url">Send</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
